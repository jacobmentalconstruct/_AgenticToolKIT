...
HOW TO USE:
  - Metadata: python src/tools/module_decomp_planner.py metadata
  - Run:      python src/tools/module_decomp_planner.py run --input-json '{"path": "src/app.py"}'
INPUT:
...
FILE_METADATA = {
    ...
    "version": "1.2.0",
    "entrypoint": "src/tools/module_decomp_planner.py",
